...
//Function returns the score of the user
//Return type: int
...
//Function returns the score of the computer
//Return type: int
...
//Function checks whether the word inputted by the user is on the board. If it is, method returns true and add the
//word to the list of words found by the user. Else, the program returns flase, indicating the word was not found on 
//the board
//Return type:bool
bool Board::HumanWordSearch(string word) {
